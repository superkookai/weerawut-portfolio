...
const projects = [
    {id: 1, title: "iterative", description: "Learning Portal Web Site", image: iterative, tech:"HTML/CSS/Bootstrap/JS/PHP/MySQL", git: "https://github.com/superkookai/iterative.git"},
    {id: 2, title: "WEStudy(Andriod)", description: "Learning Portal App", image: westudy_android, tech:"Native Android with Kotlin/Firebase", git: "https://github.com/superkookai/WEStudy.git"},
    {id: 3, title: "WEStudy(iOS)", description: "Learning Portal App", image: westudy_ios, tech:"Native iOS with Swift/Firebase", git: "https://github.com/superkookai/WEStudy-iOS.git"},
    {id: 4, title: "REST PMS", description: "Product Management System", image: rest_product, tech:"Go/ReactJS/Bootstrap", git: "https://github.com/superkookai/REST-Product-Management-System.git"},
    {id: 5, title: "Fitbook", description: " Exercise Activity Tracker Web App", image: fibook, tech:"MERN Stack", git: "https://github.com/anutpri/Team-A-1.git"},
]

function Projects(){
    return (
        <div className="container mt-5 text-center" id="projects">
            <h1 className='border-bottom border-white pb-3'>Projects</h1>
                ...
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        ...
                        <div className={`w-100 mt-3 py-2 ${styles.projectContent}`}>
                            ...
                            <h6><a href={projects[0].git} target="_blank">GitHub Repo</a></h6>
                        </div>
                    </div>
                    <div className="carousel-item">
                        ...
                        <div className={`w-100 mt-3 py-2 ${styles.projectContent}`}>
                            ...
                            <h6><a href={projects[1].git} target="_blank">GitHub Repo</a></h6>
                        </div>
                    </div>
                    <div className="carousel-item">
                        ...
                        <div className={`w-100 mt-3 py-2 ${styles.projectContent}`}>
                            ...
                            <h6><a href={projects[2].git} target="_blank">GitHub Repo</a></h6>
                        </div>
                    </div>
                    <div className="carousel-item">
                        ...
                        <div className={`w-100 mt-3 py-2 ${styles.projectContent}`}>
                            ...
                            <h6><a href={projects[3].git} target="_blank">GitHub Repo</a></h6>
                        </div>
                    </div>
                    <div className="carousel-item">
                        ...
                        <div className={`w-100 mt-3 py-2 ${styles.projectContent}`}>
                            ...
                            <h6><a href={projects[4].git} target="_blank">GitHub Repo</a></h6>
                        </div>
                    </div>        
                </div>
